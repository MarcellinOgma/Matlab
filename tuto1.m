...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)zz
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA
var1=str2num(get(handles.e1,'String'));
var2=str2num(get(handles.e2,'String'));
res=var1+var2;
set(handles.text,"String",res);
